...
const billInput = document.querySelector("#billValue");
const customTipInput = document.querySelector(".custom-tip-input");
const numberOfPeopleInput = document.querySelector("#number-0f-people-input");
const tipAmountValue = document.querySelector(".tip-value");
